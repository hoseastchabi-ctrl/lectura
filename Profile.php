...
<head>
  ...
  <title>Profil Lecteur - Lectura</title>
  ...
  <main>
    ...
    <section class="profile-card">
      <div class="profile-header">
        ...
        <div>
          <h2>Hoseas Chabi</h2>
          <p class="profile-bio">Passionné de lecture et de découverte de nouvelles histoires. J’aime explorer différents genres et partager mes lectures préférées.</p>
          <div class="profile-stats">
            <div><span>25</span><br>Histoires lues</div>
            <div><span>15</span><br>Favoris</div>
            <div><span>20</span><br>Téléchargements</div>
          </div>
      ...
      <form>
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="text" value="Hoseas Chabi">
          </div>
          <div class="form-group">
            <label>Email</label>
            <input type="email" value="hoseas.chabi@example.com">
          </div>
        </div>
        <div class="form-row">
          <div class="form-group">
        ...
        <div class="form-group">
          <label>Bio</label>
          <textarea rows="2">Passionné de lecture et de découverte de nouvelles histoires. J’aime explorer différents genres et partager mes lectures préférées.</textarea>
        </div>
        <div class="form-group">
